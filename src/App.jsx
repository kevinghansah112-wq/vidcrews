...
function AppInner() {
  ...
  const showBack = history.length > 0 && screen !== 'browse' && screen !== 'location'
  ...
  return (
    <div className="app">
      ...
      <main>
        {showBack && (
          <button onClick={goBack} style={{ background: 'none', border: 'none', color: 'var(--text-2)', cursor: 'pointer', fontSize: 13, marginBottom: 20, padding: 0 }}>
            ← Back
          </button>
        )}
